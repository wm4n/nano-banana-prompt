...
> Cute 3D cartoon sticker pack sheet in a perfect 4x4 grid layout, referencing the uploaded photo. The stickers have a distinct white sticker outline and colorful, vibrant render style with soft lighting. Each sticker features a highly expressive, emoji-style emotion with clear and dramatic facial features.
>
> The 16 distinct reactions are:
> 
> Row 1: 1. Rolling on floor laughing (ROFL): Character completely on its back, mouth wide open in a huge "D" shape, tears of joy streaming, accompanied by bold, playful "HAHAHA!" text. 2. Fiery Anger: Character's face deep red, steam puffing from ears, exaggerated flared nostrils, teeth gritted, dark scribbles above the head, bold red "ANGRY!" text. 3. Shy & Blushing: Character covering cheeks with both paws, big watery eyes looking up and to the side, extremely red facial blush, small hearts floating around. 4. Completely Confused: One eyebrow raised high, the other lowered, mouth twisted in a squiggly line, a large yellow "?" above the head and tiny swirl patterns in the eyes.
> 
> Row 2: 5. Pure Love/Heart Eyes: Character's eyes replaced by large pulsating red hearts, hands clasped over the chest, expression of absolute adoration, bold, bubbly "LOVE IT!" text. 6. Deep Sleepy: Character's eyes closed as thin curved lines, mouth open slightly blowing a large blue bubble, clear "Zzz" symbols floating up, bold "Zzz..." text. 7. Deep Thinking: Character with one paw on its chin, looking up with a concentrated squint, a lit yellow lightbulb floating above its head, small particles representing a lightbulb moment. 8. Shocked Surprise (OMG): Character's eyes completely wide circles with tiny pupils, mouth wide open in an "O" shape, jaw dropped, paws pressed against cheeks, accompanied by colorful "OMG!" text.
> 
> Row 3: 9. Crying/Sad: Character looking very sad with downturned mouth, large tears streaming down like waterfalls from its eyes, small blue puddles forming at its feet. 10. Proud/Confident: Character with chest puffed out, hands on hips, a confident, slightly Smug smirk, sparkles around its body, accompanied by colorful "I CAN!" text. 11. Star-Struck/Excited: Character with huge sparkly star-shaped eyes, grinning widely from ear to ear, mouth a giant open oval, colorful "Yay!" and stars bursting around it. 12. Nervous Sweat: Character sweating profusely with multiple blue sweat drops flying off its head, wide eyes looking horizontally, shaky mouth line, a small black scribble on the forehead.
> 
> Row 4: 13. Yelling/Screaming: Character's mouth open extremely wide in a vertical oval, vibrating air lines coming from the mouth, eyes squeezed shut, accompanied by bold red "WHY?!" text. 14. Giddy with Joy: Character clapping its paws together rapidly, a giant open-mouth grin, small stars and dots popping, body bouncing slightly, accompanied by colorful "YAY!" text. 15. Bored/Meh: Character with half-closed eyes, expressionless flat mouth line, head resting lazily on one paw, an air sign above the head indicating a sigh. 16. Naughty/Mischievous: Character winking one eye, with a sly, knowing tongue-out smirk, small devil horns and tail popping up, colorful "Oopsy!" text..
...
from [@TechieBySA](https://x.com/TechieBySA/status/2031336250032939433?s=20)

## 107. Animal Crossing Street

<img width="750" height="409" alt="Animal Crossing Street" src="https://github.com/user-attachments/assets/0175c1ee-ff93-43e8-8252-4b91efaddd35" />
...
> A hyper-realistic photograph of a beautiful adult woman with long, silky white hair featuring luminous platinum highlights that cascade elegantly over her shoulders, captured in a fashion editorial style against a seamless, pure amber-orange backdrop that creates a bold, minimalist color field. She wears a stunning sapphire-blue cutout dress in rich, saturated tones, featuring strategic geometric cutouts along the waist, sides, and décolletage that teasingly reveal smooth skin while the luxurious fabric drapes and clings with perfect tailoring and subtle sheen. A breathtaking amber and silver headpiece crowns her head — delicate metallic filigree intertwined with glowing amber stones and silver chains that catch the light dramatically. She is adorned with matching luxurious accessories: slender silver earrings with amber drops, a fine silver choker, and elegant bracelets that enhance the high-fashion aesthetic. Her posture is exquisitely elegant — spine straight, shoulders relaxed, head slightly tilted with a confident, serene expression and direct gaze. Soft, cinematic studio lighting sculpts every contour with ultra-realistic highlights and gentle shadows, emphasizing flawless skin texture, fabric drape, and metallic reflections. Photorealistic, ultra-detailed skin texture with natural pores and subtle luminous sheen, lifelike hair strands with individual platinum highlights, intricate dress cutouts and fabric realism, precise headpiece and jewelry details with accurate gemstone refraction, sharp focus on her face and figure, high dynamic range editorial lighting, 8k resolution, highly detailed, no artifacts.

from [@BeautyVerse_Lab](https://x.com/BeautyVerse_Lab/status/2030599682406424869?s=20)

## 105. Simcity At Your City

<img width="500" height="500" alt="Simcity At Your City" src="https://github.com/user-attachments/assets/dd89f642-30bf-4f81-a7be-49185cfc84ec" />

### Prompt

> Before generating this image, search the web for the most current available data for [CITY NAME]: GDP, population, GDP growth rate, AQI, current weather, temperature, city area km², founding year, and top 6-7 landmarks with their real geographic positions. Replace every data field with real retrieved numbers before rendering. Zero placeholders allowed.
> 
> RENDERING STYLE:
...
from [@0x00_Krypt](https://x.com/0x00_Krypt/status/2029815024253104301?s=20)
...
{
  "subject": {
    "type": "beautiful young woman (early 30s)",
    "pose": "sitting sideways on a concrete street barrier, sitting sideways on a concrete street barrier, one knee up, one arm resting on it, smiling at the camera",
    "expression": "cute, confident, joyful"
  },
  "appearance": {
    "hair_color": "light brown with subtle highlights",
    "hair_style": "long straight hair, loose with slight wave at ends",
    "complexion": "fair with warm undertones"
  },
  "clothing": {
    "top": "skinny fit light pink hoodie with front pocket and hood down",
    "bottom": "fit light blue jeans, slightly rolled at ankles",
    "shoes": "simple white low-top sneakers with white laces",
    "accessories": "delicate silver necklace with small pendant, small silver hoop earrings"
  },
  "environment": {
  ...
  "camera": {
    ...
    "type": "digital SLR",
    "position": "eye level, about 10 feet away",
  ...
  "art_overlay": {
    "style": "dense maximalist cartoon-characters retro pop-art cluster",
    "illustrated_elements": {
      "monsters": "tom and jerry, Bugs Bunny, Daffy Duck, Tweety, Porky Pig, Road Runner, Winnie-the-Pooh, Tigger, Piglet, Mickey Mouse, Donald Duck, Goofy, Pluto, Chip and Dale, Scooby-Doo",
...
## 26. Generate Technical View of Something

<img width="500" height="273" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/c2e9f133-1a26-4875-94c4-9e0e9226fa4a" />

### Prompt

> Generate an ultra-detailed, hyperrealistic exploded technical view of {touch panel}.
...
from [@dotey](https://x.com/dotey/status/1998454127152500959?s=20)
...
Paste the below prompt into your AI tool ask it to write for you by providing 1) scene/location 2) era1 and era2. e.g. Rewrite the prompt using Tokyo for scene and Era1 = present day, Era2 = 1000 years from now
...
<img width="500" height="273" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/b7ac890e-fd5c-4993-ae05-5811b52f73bd" />
...
## 38. Consistent Game Asset - Chest

<img width="500" height="273" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/cae84049-3929-4e04-91b3-de04a97d62c0" />

### How to use the prompt

Paste the below prompt into your AI tool and ask it to re-write prompt for different subject. e.g. bulging burlap money sacks, cute ceramic piggy banks.

### Prompt

>  vector game art, game asset sheet, 2d sprites, flat colors, clean lines, cel shading style.
> 
> Three wooden treasure chests with thick gold trim arranged horizontally in a row, isometric view.
> From left to right:
> 1) First chest is pristine, complete, intact state, polished wood, shiny gold metal bands and lock, closed lid.
> 2) Second chest is the same model but slightly damaged state, minor cracks on the wood planks, scratches and dents on the gold trim, slightly chipped edges.
> 3) Third chest is the same model but heavily damaged state, destroyed, smashed open, broken wooden planks with gaping holes, bent and broken gold trim pieces, debris scattering, hinge broken.
> 
...
<img width="500" height="896" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/1c905ad6-b472-4375-a0f6-f9f4fd67aed0" />

### Prompt

> **[Variable Definition]**
> Let **{city_name}** = "{_______}" (User Input).
...
from [@0x00_Krypt](https://x.com/0x00_Krypt/status/2002762402539171994?s=20)

## 58. Brand Poster

<img width="500" height="670" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/c1dae044-80e7-4986-a2f0-e8860f323f69" />
...
<img width="500" height="273" alt="Gemini_Generated_Image" src="https://github.com/user-attachments/assets/5ac6abe5-8df8-4600-8ef2-a3f9a7e14bb6" />
...
## 64. Photo with Your Idol

<img width="500" height="947" alt="With Spongebob" src="https://github.com/user-attachments/assets/a146631d-2016-4ba0-b68e-37919c7bc82a" />
...
"image_generation": {
  ...
  "subject":{ "description": "{PERSON} in the uploaded photo, preserve facial expression"}, 
  "clothing":{ "Top": {"type": "knitted sweater", "color": "ocean blue (spongebob's house)"},
               "pants": {"type": "preserve original as in uploaded photo" },
               "shoes": {"type": "children sport shoe", "color": "white" } },
  "pose": "standing with arm around a giant 3D Spongebob", 
  "expression": "fun, mischievous",
  "character_element":{
    "name": "Spongebob", 
    "type': "3D photorealistic duo", 
    "interaction': "Spongebob stand still and wearing chef uniform as he does in the animation while cooking,
  },
  "environment-background": "Inside Krusty Krab"
}
```

from [@ZaraIrahh](https://x.com/ZaraIrahh/status/2005816508602278010?s=20)

## 65. City Brush

<img width="500" height="500" alt="Brush_Auckland" src="https://github.com/user-attachments/assets/71765b1d-893d-40f1-b037-4520c7288ae5" />
...
## 67. Sketch and Watermark

<img width="500" height="267" alt="Sketch and Watermark" src="https://github.com/user-attachments/assets/acd4a4e6-e4b1-40e7-9b5e-b072e167a2c0" />

### How to use this prompt

Replace {the uploaded photo} with your subject and {watermark text}
...
## 77. NotebookLM Presentation Prompt

<img width="500" height="279" alt="NotebookLM Presentation Prompt" src="https://github.com/user-attachments/assets/f53b18f3-0ea2-4711-87ae-ef02cd0aa933" />
...
> 請你扮演一名PPT 結構設計師 + 定格動畫分鏡導演，幫我把【原始資料】整理成一份黏土定格動畫（clay stop-motion）主題的中文簡報。一、基礎參數（可自訂）
> 主題：【填寫本次演講主題】
> 原始資料類型：【例如：論文/書籍章節/課程筆記/訪談/視訊字幕】
> 目標觀眾：【例如：大學生/小白投資者/職場新人/中學生】
> 講解口吻：【例如：幽默一點/嚴謹一點/像老朋友聊天/像公開課】
> 預計頁數：【10–15】 頁左右
> 二、你的任務
> 
> 先通讀我給你的【原始資料】，提煉出：3–5 個核心章節
> 每個章節下 2–4 個關鍵知識點或故事
> 把這些內容改寫成一份適合演示的 PPT，大綱清晰、邏輯循序漸進，不要逐字照抄資料。
> 
> 整套 PPT 的視覺設定統一為：畫面全部是黏土風格的定格動畫場景
> 人物、物體、背景都由黏土塑形，帶有手工質感和輕微瑕疵
> 顏色飽和度適中，看起來溫暖、有趣，而不是寫實 3D。
> 三、每一頁 PPT 的輸出格式
> 請按「幻燈片 1、幻燈片 2、……」依次輸出，每一頁必須包含以下 4 部分：標題：一句話點題，儘量口語化、易懂。
> 
> 要點列表（3–5 條）：用簡短 bullet 講清楚這一頁的核心資訊
> 句子不要太長，適合在 PPT 上展示
> 儘量用比喻、生活場景解釋抽象概念。
> 
> 演講備註（Speaker Notes）：以【第一人稱】講解，好像我在對觀眾說話
> 每頁 80–150 字左右，用來擴展要點、講小故事或舉例
> 語氣符合前面設定的【講解口吻】。
> 
> 配圖設計說明（黏土定格動畫風格）：詳細描述一張畫面，用於後續讓圖像模型生成插圖
> 
> 必須指明：場景地點（教室/城市街道/辦公室/宇宙等）
> 主角/人物是怎樣的黏土角色，在做什麼，表情如何
> 還出現了哪些關鍵物體/符號（如書本、圖表、路牌、齒輪、錢幣等）
> 鏡頭氛圍（溫暖/緊張/勵志/搞笑）
> 畫面風格統一為 clay stop-motion animation，強調整體是“逐幀拍攝的黏土動畫感”，而不是平面插畫。
> 四、整體結建構議
> 幻燈片 1：封面（主題 + 副標題 + 黏土風格主視覺）
> 幻燈片 2：目錄 / 本次要解決的三個問題
> 幻燈片 3–【倒數第2頁】：按章節展開內容（每章可以用 2–4 頁）
> 倒數第 2 頁：總結與關鍵 takeaway（3–5 條）
> 最後一頁：行動建議 / Q&A，引導觀眾接下來可以做的 2–3 個具體行動。
> 五、輸出要求
> 請嚴格按「幻燈片 N：」分段輸出，方便我直接複製到 PPT 工具中。
> 不要真正畫圖，唯寫文字版的配圖描述。
> 用簡體中文輸出。
> 下面是【原始資料】，請根據上面要求開始生成黏土定格動畫風格的 PPT：【在這裡貼上/概括：我要轉換的資料/文件內容/視訊指令碼/字幕文字】

from [@rionaifantasy](https://x.com/rionaifantasy/status/2013147408629408098?s=20)

## 78. Different Hair Style

<img width="500" height="373" alt="Different Hair Style" src="https://github.com/user-attachments/assets/74e7517e-a169-42c0-a0d1-01466ffed9bd" />
...
from [@AIwithSynthia](https://x.com/AIwithSynthia/status/2013225585297043665?s=20)

## 79. Tech Evolution Map

<img width="500" height="279" alt="Video Game Console Tech Evolution Map" src="https://github.com/user-attachments/assets/0c7f5077-5758-4746-9373-3524a639c612" />

### Prompt

> Create a clear, 45° top-down isometric miniature 3D diorama illustrating the evolution of {TECH TOPIC}.
>
> Use soft refined textures, realistic PBR materials, and clean futuristic lighting.
>
> Build a linear or circular raised base showing different tech eras with tiny models of devices.
> Include tiny stylized engineers or users (no facial details).
>
> Use a clean solid {BACKGROUND COLOR} background.
> At the top-center, display {TECH TOPIC} in large bold text, beneath it show a subtitle like {FROM YEAR – TO YEAR}, and place a minimal tech icon below.
>
> All text must automatically match the background contrast (white or black)

from [@aleenaamiir](https://x.com/aleenaamiir/status/2013103212057043110?s=20)

## 80. Cuisine Recipe

<img width="500" height="500" alt="Hot Pot Recipe" src="https://github.com/user-attachments/assets/3877f47f-e70c-4eca-a1c6-6e25f9023fe8" />
...
<img width="500" height="279" alt="3D Newspaper" src="https://github.com/user-attachments/assets/3d222088-0982-4b4a-b043-16a23f39d4fe" />
...
>
> 1. THE FRONT PANEL (2D): The front face is a perfectly flat, vertical, aged/modern newspaper page. Masthead: At the top, the title "DAILY CHRONICLE" is printed in a classic, bold serif font. Main Headline: Directly below the title, a massive, bold, all-caps headline reads: "{HEADLINE TITLE}".
...
from [@Arminn_Ai](https://x.com/Arminn_Ai/status/2026005537968558304?s=20)

## 96. Story Telling

<img width="1000" height="545" alt="9-photo collage collection telling a complete fitness journey story" src="https://github.com/user-attachments/assets/c708a121-b482-409d-9332-3738fb71c8c5" />

### Prompt

> Ultra-realistic cinematic 9-photo collage collection telling a complete fitness journey story of a young athletic woman traveling from her home to the gym and returning back home, each frame showing a different scene and progression, strong visual storytelling, consistent character identity across all images (same face, same hairstyle, same gym outfit), natural body proportions, photorealistic skin texture, lifestyle editorial photography, no CGI, no illustration, ultra-detailed, 8K resolution.
>
> Frame 1: Inside her bedroom, she prepares for the gym, adjusting her workout clothes in front of a mirror, soft morning sunlight entering through the window, calm focused mood.
>
> Frame 2: At the home entrance, she picks up her gym bag and opens the door, natural indoor lighting, realistic home interior, storytelling beginning.
> 
> Frame 3: Outside her house, she boards her bicycle, one foot on the pedal, preparing to ride, residential street background, cinematic morning light.
> 
> Frame 4: She rides the bicycle on the street toward the gym, side-angle action shot, natural motion blur, dynamic composition, urban environment.
> 
> Frame 5: She arrives at the gym exterior and parks her bicycle near the entrance, modern gym building with glass facade, confident expression, realistic reflections.
> 
> Frame 6: Inside the gym, she performs an exercise such as lifting dumbbells or doing squats, focused expression, visible effort, professional gym environment, dramatic lighting.
> 
> Frame 7: She takes a break and drinks water from a bottle, slightly sweaty, natural post-workout moment, blurred gym equipment background, candid realism.
>
> Frame 8: She exits the gym and walks toward her bicycle, carrying her gym bag, relaxed and satisfied expression, warm evening light, cinematic atmosphere.
> 
...
## 98. 3D Character from Different Angle View

<img width="500" height="273" alt="3D Character from Different Angle View" src="https://github.com/user-attachments/assets/253b25a7-6bdf-4b3a-815f-626c31eee88f" />
...
## 99. 3D Relief Diorama

<img width="500" height="1011" alt="3D Relief Diorama" src="https://github.com/user-attachments/assets/5bcfd522-9971-445b-981a-11489b131044" />

### How to use this prompt

Ask your AI tool to fill the prompt below for your target location

### Prompt

> Detailed 3D relief diorama of [CULTURE/LOCATION] [DAILY LIFE SCENE]. Multi-layered composition with [BUILDING TYPE] featuring [ARCHITECTURAL DETAIL] in middle ground, foreground filled with [FIGURES IN TRADITIONAL DRESS] at [FOOD MARKET], [LOCAL VEHICLES] on tiny roads, [DECORATIVE CULTURAL ITEMS] and [FLORA/FAUNA] scattered throughout. Large embossed text "[LOCATION NAME]" at top. Mounted on [MATERIAL] base with [EDGE TREATMENT]. Semi-relief Pixar clay style, [COLOR SCHEME: monochrome white/vibrant colors], high visual density, [LIGHTING: soft studio/warm golden], clean commercial illustration aesthetic, miniature scale magic. --ar 1:2

from [@0x00_Krypt](https://x.com/0x00_Krypt/status/2026568040922624090?s=20)

## 100. White Clay Rendered City

<img width="500" height="1011" alt="White Clay Rendered City" src="https://github.com/user-attachments/assets/b02df41e-0b9f-424a-b32a-1736fade6e96" />
...
## 103. Painterly Mountain

<img width="500" height="273" alt="Painterly Mountain" src="https://github.com/user-attachments/assets/c7c2ebb5-16eb-43bb-991e-88a2c2c4dce4" />

### Prompt

> A winding mountain pass filled with colorful prayer flags stretching between weathered stone pillars, fluttering in strong alpine wind. Travelers move along a narrow path below while clouds roll through the valley, revealing distant snow-covered peaks. Rendered in expressive painterly style with rich color transitions, atmospheric depth, and dynamic movement in fabric and sky.

from [@BeanieBlossom](https://x.com/BeanieBlossom/status/2029482315240632552?s=20)

## 104. Soft Toy Cartoon Character

<img width="500" height="667" alt="Soft Toy Cartoon Character" src="https://github.com/user-attachments/assets/74deef80-6428-4db4-8bcd-bf0e4a9a7bcf" />
...
from [@ChillaiKalan__](https://x.com/ChillaiKalan__/status/2029730855908954544?s=20)
